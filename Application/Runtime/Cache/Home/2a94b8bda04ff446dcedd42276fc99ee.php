...
<head>
    ...
    <link rel="stylesheet" href="/Sample_CMS/Public/css/bootstrap.min.css" type="text/css"/>
    <link rel="stylesheet" href="/Sample_CMS/Public/css/home/main.css" type="text/css"/>
</head>
<body>
<header id="header">
    <div class="navbar-inverse">
        <div class="container">
            <div class="navbar-header" style="margin-top: 20px">
                <a href="/Sample_CMS/"
                   style="text-decoration: none; font-weight: bolder; font-size: larger; color: white">
                    <!--<img src="/Sample_CMS/Public/images/logo.png" alt="">-->
                    Sample_CMS
                </a>
            </div>
            <ul class="nav navbar-nav navbar-left">
                <li><a href="/Sample_CMS/"
                    <?php if($result['catId'] == 0): ?>class="curr"<?php endif; ?>
                    >首页</a></li>
                <?php if(is_array($navs)): foreach($navs as $key=>$vo): ?><li><a href="/Sample_CMS/index.php?c=cat&id=<?php echo ($vo["menu_id"]); ?>"
            ...
            <div class="col-sm-9 col-md-9">
                <div class="banner">
                    <div class="banner-left">
                        ...
                        <a target="_blank"
                           href="/Sample_CMS/index.php?c=detail&id=<?php echo ($result['topPicNews'][0]['news_id']); ?>"><img
                    ...
                    <div class="banner-right">
                        <ul>
                            <?php if(is_array($result['topSmailNews'])): $i = 0; $__LIST__ = $result['topSmailNews'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                                    <a target="_blank" href="/Sample_CMS/index.php?c=detail&id=<?php echo ($vo["news_id"]); ?>"><img
                                            width="150"
                                            height="113"
                ...
                <div class="news-list">
                    <?php if(is_array($result['listNews'])): $i = 0; $__LIST__ = $result['listNews'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl>
                            <dt><a target="_blank" href="/Sample_CMS/index.php?c=detail&id=<?php echo ($vo["news_id"]); ?>"><?php echo ($vo["title"]); ?></a></dt>
                            <dd class="news-img">
                                <a target="_blank" href="/Sample_CMS/index.php?c=detail&id=<?php echo ($vo["news_id"]); ?>"><img width="200"
                                                                                                    height="120"
                                                                                                    src="<?php echo ($vo["thumb"]); ?>"
                                                                                                    alt="<?php echo ($vo["title"]); ?>"></a>
                            </dd>
    ...
    <div class="right-content">
        <ul>
            <?php if(is_array($result['rankNews'])): $k = 0; $__LIST__ = $result['rankNews'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><li class="num<?php echo ($k); ?> curr">
                    <a target="_blank" href="/Sample_CMS/index.php?c=detail&id=<?php echo ($vo["news_id"]); ?>"><?php echo ($vo["small_title"]); ?></a>
...
<script src="/Sample_CMS/Public/js/count.js"></script>
</html>