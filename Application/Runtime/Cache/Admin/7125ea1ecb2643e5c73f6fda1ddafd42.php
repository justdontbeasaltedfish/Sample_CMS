                ...
                <div class="col-lg-6">
                    ...
                    <form class="form-horizontal" id="singcms-form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" value="<?php echo ($vo["url"]); ?>" name="url" id="inputPassword3"
                                       placeholder="请url地址">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="news_id" value="<?php echo ($vo["news_id"]); ?>" class="form-control"
...
<script>
    var SCOPE = {
        'save_url': '/Sample_CMS/admin.php?c=positioncontent&a=add',
        'jump_url': '/Sample_CMS/admin.php?c=positioncontent&a=index',
