...
<script>
    var SCOPE = {
        'edit_url': '/Sample_CMS/admin.php?c=positioncontent&a=edit',
        'set_status_url': '/Sample_CMS/admin.php?c=positioncontent&a=setStatus',
        'add_url': '/Sample_CMS/admin.php?c=positioncontent&a=add',
        'listorder_url': '/Sample_CMS/admin.php?c=positioncontent&a=listorder',
    }
