        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        <li>
                            <i class="fa fa-dashboard"></i> <a href="/Sample_CMS/admin.php?c=menu">菜单管理</a>
                        </li>
                        <li class="active">
            ...
            <!-- /.row -->
            <div class="row">
                <form action="/CMS/admin.php" method="get">
...
<script>
    ...
    var SCOPE = {
        'add_url': '/Sample_CMS/admin.php?c=menu&a=add',
        'edit_url': '/Sample_CMS/admin.php?c=menu&a=edit',
        'set_status_url': '/Sample_CMS/admin.php?c=menu&a=setStatus',
        'listorder_url': '/Sample_CMS/admin.php?c=menu&a=listorder',
