...
<script>
    ...
    var SCOPE = {
        'add_url': '/CMS/admin.php?c=menu&a=add',
        'edit_url': '/CMS/admin.php?c=menu&a=edit',
        'set_status_url': '/CMS/admin.php?c=menu&a=setStatus',
        'listorder_url': '/CMS/admin.php?c=menu&a=listorder',
