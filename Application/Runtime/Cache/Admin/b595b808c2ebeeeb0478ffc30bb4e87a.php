            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        您好<?php echo getLoginUsername()?>!欢迎使用Sample_CMS内容管理平台
                    </h1>
                    <ol class="breadcrumb">
                        <li class="active">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-green">
                        ...
                        <a href="/Sample_CMS/admin.php?c=content&a=index">
                            <div class="panel-footer">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-yellow">
                        ...
                        <a target="_blank" href="/Sample_CMS/index.php?c=detail&id=<?php echo ($news["news_id"]); ?>">
                            <div class="panel-footer">
                                <span class="pull-left"></span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-red">
                        ...
                        <a href="/Sample_CMS/admin.php?c=position">
                            <div class="panel-footer">
                                <span class="pull-left">查看</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
