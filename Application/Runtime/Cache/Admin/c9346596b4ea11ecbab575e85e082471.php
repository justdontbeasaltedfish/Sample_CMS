...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <script src="/Sample_CMS/Public/js/kindeditor/kindeditor-all.js"></script>
    <div id="page-wrapper">
                ...
                <div class="col-lg-6">
                    ...
                    <form class="form-horizontal" id="singcms-form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input value="<?php echo ($news["title"]); ?>" type="text" name="title" class="form-control"
                                       id="inputname" placeholder="请填写标题">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputname" class="col-sm-2 control-label">短标题:</label>
                            <div class="col-sm-5">
                                <input value="<?php echo ($news["small_title"]); ?>" type="text" name="small_title" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                ...
                                <img style="display: none" id="upload_org_code_img" src="<?php echo ($news["thumb"]); ?>" width="150"
                                     height="150">
                                <input id="file_upload_image" name="thumb" type="hidden" multiple="true"
                                       value="<?php echo ($news["thumb"]); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select class="form-control" name="title_font_color">
                                    ...
                                    <?php if(is_array($titleFontColor)): foreach($titleFontColor as $key=>$color): ?><option value="<?php echo ($key); ?>"
                                        <?php if($key == $news['title_font_color']): ?>selected="selected"<?php endif; ?>
                            ...
                            <div class="col-sm-5">
                                <select class="form-control" name="catid">
                                    ...
                                    <?php if(is_array($webSiteMenu)): foreach($webSiteMenu as $key=>$sitenav): ?><option value="<?php echo ($sitenav["menu_id"]); ?>"
                                        <?php if($sitenav['menu_id'] == $news['catid']): ?>selected="selected"<?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select class="form-control" name="copyfrom">
                                    <?php if(is_array($copyfrom)): foreach($copyfrom as $key=>$cfrom): ?><option value="<?php echo ($key); ?>"
                                        <?php if($key == $news['copyfrom']): ?>selected="selected"<?php endif; ?>
                                        ><?php echo ($cfrom); ?></option><?php endforeach; endif; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input value="<?php echo ($news["description"]); ?>" type="text" class="form-control" name="description"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input value="<?php echo ($news["keywords"]); ?>" type="text" class="form-control" name="keywords"
...
<script>
    var SCOPE = {
        'save_url': '/Sample_CMS/admin.php?c=content&a=add',
        'jump_url': '/Sample_CMS/admin.php?c=content',
        'ajax_upload_image_url': '/Sample_CMS/admin.php?c=image&a=ajaxuploadimage',
        'ajax_upload_swf': '/Sample_CMS/Public/js/party/uploadify.swf',
    };

</script>
<!-- /#wrapper -->
<script src="/Sample_CMS/Public/js/admin/image.js"></script>
<script>
    // 6.2
    KindEditor.ready(function (K) {
        window.editor = K.create('#editor_singcms', {
            uploadJson: '/Sample_CMS/admin.php?c=image&a=kindupload',
            afterBlur: function () {
                this.sync();
            }, //
        });
