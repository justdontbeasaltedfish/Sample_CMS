...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <form action="/Sample_CMS/admin.php" method="get">
                    <div class="col-md-3">
                            ...
                            <table class="table table-bordered table-hover singcms-table">
                                ...
                                <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><span class="sing_cursor glyphicon glyphicon-edit" aria-hidden="true"
                                            ...
                                            <a target="_blank" href="/Sample_CMS/index.php?c=detail&a=view&id=<?php echo ($new["news_id"]); ?>"
...
<script>
    var SCOPE = {
        'edit_url': '/Sample_CMS/admin.php?c=content&a=edit',
        'add_url': '/Sample_CMS/admin.php?c=content&a=add',
        'set_status_url': '/Sample_CMS/admin.php?c=content&a=setStatus',
        'sing_news_view_url': '/Sample_CMS/index.php?c=view',
        'listorder_url': '/Sample_CMS/admin.php?c=content&a=listorder',
        'push_url': '/Sample_CMS/admin.php?c=content&a=push',
    }
</script>
