        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        <li>
                            <i class="fa fa-dashboard"></i> <a href="/Sample_CMS/admin.php?c=admin">用户管理</a>
                        </li>
                        <li class="active">
...
<script>
    var SCOPE = {
        'add_url': '/Sample_CMS/admin.php?c=admin&a=add',
        'edit_url': '/Sample_CMS/admin.php?c=admin&a=edit',
        'set_status_url': '/Sample_CMS/admin.php?c=admin&a=setStatus',
        'index_url': '/Sample_CMS/',
